 ...
 * Module Class
 */
class LCPROEXT_Ninja_Forms extends DSLC_Module {
	...
	function __construct() {
		$this->module_id = 'LCPROEXT_Ninja_Forms';
 ...
 */
function lcextpro_alter_nf_defaults_in_lc( $options, $id ) {
	// The array that will hold new defaults.
	$new_defaults = array();

	if ( 'LCPROEXT_Ninja_Forms' == $id ) {
		$new_defaults = array(
...
add_filter( 'dslc_module_options', 'lcextpro_alter_nf_defaults_in_lc', 10, 2 );

function lcextpro_ninja_forms_custom_display_before_field( $field_id, $data ) {
	// Wrap HR with extra div for esier styling.
	if ( 'hr' == $data['label'] ) {
		echo '<div class="field-wrap hr-wrap">';
	}
}
add_action( 'ninja_forms_display_before_field', 'lcextpro_ninja_forms_custom_display_before_field', 10, 2 );

function lcextpro_ninja_forms_custom_display_after_field( $field_id, $data ) {
	// Wrap HR with extra div for esier styling.
	if ( 'hr' == $data['label'] ) {
		echo '</div>';
	}
}
add_action( 'ninja_forms_display_after_field', 'lcextpro_ninja_forms_custom_display_after_field', 10, 2 );

/**
 * Register Module
 */
function lcextpro_ninja_forms_init_module() {
	return dslc_register_module( 'LCPROEXT_Ninja_Forms' );
}
add_action( 'dslc_hook_register_modules', 'lcextpro_ninja_forms_init_module' );
