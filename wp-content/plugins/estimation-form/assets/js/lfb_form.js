...
jQuery(document).ready(function () {
    if (jQuery('#estimation_popup').length > 0) {
        ...
        initFlatUI();
        wpe_initForms();
        jQuery.each(wpe_forms, function () {boo
            var form = this;
    ...
    jQuery.each(wpe_forms, function () {
        ...
        if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').length > 0) {
            ...
            if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wtmt_paypalForm').length == 0) {
                // jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wpe_btnOrder').hide();
            }
        }
        ...
        if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns').length > 0) {
            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns [data-payment="paypal"]').click(function () {
                jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').slideUp();
                                    ...
                                    setTimeout(function () {
                                        if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').is('.wpe_fullscreen')) {
                                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]').animate({
                                                scrollTop: jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #lfb_stripeForm').offset().top - (80 + parseInt(form.scrollTopMargin))
                                        ...
                                        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wpe_btnOrderStripe').parent().show();
                                        jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wpe_btnOrderStripe').slideDown();
                                    }, 350);
                                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').slideDown();
                                } else {
    ...
    jQuery.ajax({
        ...
        success: function (current_ref) {
            if (current_ref.indexOf('stripeError:') == 0) {
                ...
                if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').length > 0 && form.price > 0) {
                    var payPrice = parseFloat(form.price);
                    if (form.payMode == 'percent') {
                        payPrice = parseFloat(payPrice) * (parseFloat(form.percentToPay) / 100);
                    } else if (form.payMode == 'fixed') {
                        payPrice = parseFloat(form.fixedToPay);
...
function wpe_changeStep(stepID, formID) {
    ...
    var activatePaypal = true;
    if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').length == 0 && jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wtmt_paypalForm').length == 0) {
        activatePaypal = false;
    }
    if (stepID == 'final') {
        ...
        if (activatePaypal) {
            ...
            if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns').length > 0) {
                if (lfb_lastSteps.length > 0) {
                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns .linkPrevious').show();
                } else {
                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns .linkPrevious').hide();
                }
            ...
            if (activatePaypal) {
                if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_paymentMethodBtns').length == 0) {
                    if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm').length > 0) {
                        ...
                        jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #mainPanel .genSlide[data-stepid="' + stepID + '"] .genContentSlide > .linkPrevious').hide();

                        jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #lfb_stripeForm .lfb_btnNextContainer').show();
                        jQuery(' #estimation_popup.wpe_bootstraped[data-form="' + formID + '"] #lfb_stripeForm .linkPrevious').show();
                        if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_captcha-wrap').length > 0 && jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wtmt_paypalForm').length == 0) {
                            jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_captcha-wrap').detach().insertAfter(jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"]  #lfb_stripeForm .lfb_stripeContainer'));
                        }
                    } else if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #wtmt_paypalForm').length > 0) {
                ...
                if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm #lfb_captcha-wrap').length > 0) {
                    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_captcha-wrap').detach().insertAfter(jQuery('#estimation_popup.wpe_bootstraped[data-form="' + form.formID + '"] #lfb_stripeForm '));
                }
...
function lfb_executeCalculation(calculation, formID, targetID) {
    ...
    if (jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"]').is('[data-isSubs]') && $target.is('[data-singleprice="true"]')) {
                        ...
                        if (jQuery(this).is('[data-usecalculation]')) {
                            if(step == form.step || !jQuery(this).is('.lfb_executed')){
                                if (form.step != 'final' || lfb_executeCalculation(jQuery(this).attr('data-calculation'), formID, jQuery(this).attr('data-itemid')) != 0) {
                                    ...
                                    jQuery(this).addClass('lfb_executed');
                                }
                            }  else {                      
...
function lfb_updateRichTextValues(formID) {
    ...
    jQuery('#estimation_popup.wpe_bootstraped[data-form="' + formID + '"] .genSlide[data-stepid="' + form.step + '"] .lfb_richtext[data-itemid]:not(.lfb_shortcode) .lfb_richVariable').each(function () {
        var i = 0;
        var _stepID = parseInt(jQuery(this).closest('.genSlide').attr('data-stepid'));
