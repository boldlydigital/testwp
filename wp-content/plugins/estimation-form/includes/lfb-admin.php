...
class LFB_admin {
    ...
    public function view_edit_lfb() {
        if (current_user_can('manage_options')) {
            ...
            . '<a href="javascript:" onclick="lfb_refreshLogs();" class="btn btn-default" style="margin-right: 12px;"><span class="fa fa-sync-alt"></span>' . __('Refresh', 'lfb') . '</a>'
        ...
        <div class="modal fade" id="modal_removeAllSteps" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog">
           ...
           <input type="text" class="form-control" name="saveForLaterIcon"  data-iconfield="1" style="width: 226px;" />
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group" >
                             ...
                             <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="floatSummary_icon" placeholder="fa fa-rocket" data-iconfield="1" style="width: 226px;" />
                                <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
                            </div>';
            /* <div class="form-group" >
              <label> ' . __('Bubble summary icon', 'lfb') . ' </label>
 ...
 <div class="form-group" >
                             ...
                             <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="nextStepButtonIcon" placeholder="fa fa-rocket" data-iconfield="1" style="width: 226px;" />
                                <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
                            </div>';
            ...
            echo '
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="previousStepButtonIcon" placeholder="fa fa-rocket" data-iconfield="1" style="width: 226px;" />
                                <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
                            </div>';
            ...
            echo' <div class="form-group" >
                                ...
                                <input type="text" class="form-control" name="finalButtonIcon" placeholder="fa fa-rocket" data-iconfield="1" style="width: 226px;" />
                                <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
                            </div>';
            /*   echo'<div class="form-group" >
              <label> ' . __('Final button icon', 'lfb') . ' </label>
		...
		<p style="text-align: center; padding-top: 28px;" ><a href="javascript:" onclick="lfb_saveForm();" class="btn btn-lg btn-primary" ><span class="glyphicon glyphicon-floppy-disk" ></span > ' . __('Save', 'lfb') . ' </a ></p >
            ...
            echo '<a href="javascript:" onclick="lfb_openLeftPanel(\'lfb_calendarDaysWeek\');" class="btn btn-circle btn-default" data-toggle="tooltip" title="' . __('Available days of week', 'lfb') . '" data-placement="left"><span class="fa fa-calendar-check"></span></a>';
            echo '<a href="javascript:" onclick="lfb_openLeftPanel(\'lfb_calendarHoursEnabled\');" class="btn btn-circle btn-default" data-toggle="tooltip" title="' . __('Available hours', 'lfb') . '" data-placement="left"><span class="fa fa-clock"></span></a>';
            ...
            foreach ($formsCal as $formCal) {
                $logs = $wpdb->get_results($wpdb->prepare("SELECT id,formID,checked,ref FROM " . $wpdb->prefix . "wpefc_logs WHERE formID=%s AND checked=1 ORDER BY id DESC", $formCal->id));
                foreach ($logs as $log) {
            ...
            echo '<a href="javascript:" class="btn btn-primary" onclick="lfb_downloadOrder();"><span class="glyphicon glyphicon-cloud-download"></span>' . __('Download as PDF', 'lfb') . '</a>';
...
if(([item-3_quantity] >5) ) {
	([item-3_price]/2)*([item-1_quantity])
           ...
           <input type="text" class="form-control" name="icon" placeholder="fa fa-rocket" data-iconfield="1"  style="width: 226px;" />
           <a href="https://fontawesome.com/icons?d=gallery&m=free" target="_blank" style="margin-left: 8px;" class="btn btn-info btn-circle"><span class="glyphicon glyphicon-search"></span></a>
...
if(([item-3_quantity] >5) ) {
	([item-3_price]/2)*([item-1_quantity])
            ...
            echo '</div>';
            echo '<div class="clearfix"></div>';
            /* echo ' <p style="margin-bottom: 0px;"><strong>' . __('Integrate the form in a page', 'lfb') . ':</strong></p>
        ...
        if (current_user_can('manage_options')) {
            ...
            foreach ($logs as $log) {
                ...
                <td>' . $verifiedPayment . '</td>
                    ...
                    <a href="javascript:" onclick="lfb_currentLogID=' . $log->id . ';lfb_downloadOrder(' . $log->id . ');" class="btn btn-default btn-circle" data-toggle="tooltip" title="' . __('Download the order', 'lfb') . '" data-placement="bottom"><span class="fa fa-file-download"></span></a>
    ...
    public function duplicateForm() {
        ...
        if (current_user_can('manage_options')) {
            ...
            $wpdb->update($table_forms, array('formStyles' => $form->formStyles, 'customCSS' => $form->customCSS, 'ref_root' => $form->ref_root), array('id' => $newFormID));
        }
        ...
        if (current_user_can('manage_options')) {
            ...
            if ($stepID != $defaultStepID) {
                ...
                foreach ($links as $link) {
                    ...
                    $chkChange = false;
                    foreach ($conditions as $condition) {
                        if (strpos($condition->interaction, $defaultStepID . '_') > -1) {
                            $chkChange = true;
                            $condition->interaction = str_replace($defaultStepID . '_', $stepID . '_', $condition->interaction);
                        }
                    }
                    if ($chkChange) {
    ...
    public function checkFirstStart() {
        ...
        if ($settings->firstStart) {
            ...
            $import_file_path = plugin_dir_path(__FILE__) . '../tmp/' . $jsonfilename;
            // Give developer possibility to manipulate the list of default demo forms.
            $import_file_path = apply_filters( 'lfb-installation-forms-import-file',  $import_file_path, $settings );
            $file = file_get_contents( $import_file_path );
            $dataJson = json_decode($file, true);
            ...
            foreach ($dataJson['items'] as $key => $value) {
                ...
                if ($value['image'] && $value['image'] != "") {
                    ...
                    $image_path_string = $imagePath;

                    if  ( is_array( $image_path_string ) ) {
                        $image_path_string = $image_path_string['url'];
                    }

                    $value['image'] =  $image_path_string . '/' . $img_name;
                }
                if (array_key_exists('reduc_qt', $value)) {
                    unset($value['reduc_qt']);
                    unset($value['reduc_value']);
