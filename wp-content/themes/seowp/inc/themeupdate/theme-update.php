...
function lbmn_theme_update_181() {
	...
	if ( ! $theme_update_ver_181_compelted ) {
		...
		$notices[] = 'Please read: SEOWP theme ver.1.8.1 can\'t be updated properly without some important actions. https://support.bandicootmarketing.com/article/82-theme-update-to-version-1-8-1';
				...
				<script type="text/javascript">
					...
					jQuery( document ).ready( function( $ ) {
						$( '.core-updates' ).before(
							...
							'<a href="https://support.bandicootmarketing.com/article/61-how-to-update-the-theme-to-the-latest-version" target="_blank" class="button">Please update now</a>' +
							'</div>');
						...
						$( '.themes-php .theme.active .theme-screenshot' ).after(
							...
							'<a href="https://support.bandicootmarketing.com/article/61-how-to-update-the-theme-to-the-latest-version" target="_blank" style="text-decoration:none">Please update</a>' +
							'</p></div>');
					});
				</script>
				<?php
