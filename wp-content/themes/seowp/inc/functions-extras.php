...
function lbmn_notice_purchase_code_needed() {
	...
	if ( ! $purchase_code && ! $notice_dismissed && $demo_imported ) {
		...
		echo '<p>' . esc_html__( 'SEO WP theme comes with automatic updates, one to one support and premium features. Please, activate your theme by <a href="https://support.bandicootmarketing.com/article/80-how-to-set-up-the-automatic-theme-updates" target="_blank">entering a purchase code.</a>', 'seowp' ) . '</p>';
		echo '</div>';
	}
}
