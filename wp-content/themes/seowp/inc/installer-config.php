...
$wizard = new Merlin(
	...
	$strings = array(
		...
		'ready-link-1'             => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://support.bandicootmarketing.com/collection/159-seowp-theme', esc_html__( 'Theme Documentation', 'seowp' ) ),
