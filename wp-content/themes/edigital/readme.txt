...
EDigital bundles the following third-party resources:
    ...
    Source: https://pixabay.com/en/ipad-tablet-technology-touch-820272/

== Changelog ==

= 1.1.8 = April 11th, 2020
    * Fixed - bugs at multicheck box field in widget.
    * updated - .pot file.

= 1.1.7 = Nov 11th, 2019
    * Navigation Script and Style for accessibility access added.
    * Theme code refine and minimized some gaping.
    * Custom scripts changes.
    * About style update.

= 1.1.6 =
    * Fixed bugs on welcome page.
    * Fixed some design tweak on single post page.
